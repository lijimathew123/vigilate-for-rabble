            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Send Krishibhavan</p>
                </div>
                <div class="card-body">
                  <form autocomplete="off" method="post" action="action/kmessage_save.php">
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Krishibhavan</label>
                         	<input list="kbhn" required class="form-control form-control-primary" name="kbhn">
                            <datalist id="kbhn">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                         <?php
                            $result = $db->prepare("select * from  kmessage where Log_Id='$Log_Id'");
                            $result->execute();
