<?php
	...
	$sql = "insert into complaintpost(Log_Id,name,sex,age,aadharno,addr,kbhn,cntno,cdate,pdate,frstry,panchayath,cname,descp,photo,photo1,photo2,kst,fsat)values('$Log_Id','$name','$sex','$age','$aadharno','$addr','$kbhn','$cntno','$cdate','$pdate','$frstry','$panchayath','$cname','$descp','$photo','$photo1','$photo2','$kst','$fsat')";
	$q1 = $db->prepare($sql);
	$q1->execute();
	
	header("location:../farmer_claims_request.php");
