...
<div class="col-sm-6 wow fadeInRight">
                    ...
                    <div class="col-sm-6 wow fadeInLeft">
                        ...
                        <div class="contact-form-block">
                            ...
                            <h2 class="contact-title">Join to us</h2>

                            <form role="form" action="register_save.php" method="post" id="contact-form" autocomplete="off">

                                <div class="form-group">
                                    <input type="text" class="form-control"  name="name" placeholder="Name"  required pattern="[a-zA-Z1 _]{3,50}">                                            
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="cntno" placeholder="Contact" required pattern="[0-9]{10,10}" maxlength="10" minlength="10" >
                                </div>
                                  <div class="form-group">
                                ...
                                <div class="form-group">
                                     <input list="utype" required class="form-control lst" name="utype" placeholder="Sign Up">
                                        <datalist id="utype">
                                            <option value="">Select</option>                                            
                                            <option>Hospital</option>
                                            <option>Krishibhavan</option>
