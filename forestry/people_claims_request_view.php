          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form method="post" action="action/hcomplaint_update.php" autocomplete="off">
                    <div class="row">
                      <div class="col-md-8">
                	...
                	<img class="img" src="../photo/<?php echo $photo1;?>" width="100%" />
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <textarea class="form-control" rows="3" name="frestryreply"></textarea>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                           <input list="fsat" required class="form-control form-control-primary" name="fsat">
                            <datalist id="fsat">
                                <option></option>
