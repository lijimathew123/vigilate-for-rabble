            ...
            <div class="container wow fadeInUp">
                ...
                <div class="row section-heading-wrapper">
                    ...
                    <div class="col-md-8 col-md-offset-2 col-sm-12 text-center">
                        <h2 class="section-heading"><span><?php echo strtoupper($name);?></span> Krishibhavan</h2>
                ...
                <div class="row">
                     ...
                     <?php				
					$result = $db->prepare("select * from user where utype='Krishibhavan' and location='$name'");
					$result->execute();
