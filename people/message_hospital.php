            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Send Hospital</p>
                </div>
                <div class="card-body">
                  <form autocomplete="off" method="post" action="action/hmessage_save.php">
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Hospital</label>
                         	<input list="hospt" required class="form-control form-control-primary" name="hospt">
                            <datalist id="hospt">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                         <?php
                            $result = $db->prepare("select * from  hmessage where Log_Id='$Log_Id'");
                            $result->execute();
